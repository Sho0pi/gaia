...
QR-pairing path unless ``GAIA_WHATSAPP_RUN_LIVE`` is set (it needs a real phone
...
@pytest.mark.skipif(
    not os.environ.get("GAIA_WHATSAPP_RUN_LIVE"),
    reason="live QR pairing needs a phone; set GAIA_WHATSAPP_RUN_LIVE to run",
)
