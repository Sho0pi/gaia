...
:class:`~godpy.connectors.base.Media` per screenshot, so a connector that supports
...
def media_for_screenshots(events: list[Any]) -> list[Media]:
    ...
    Only screenshots God itself takes are seen here — files a delegated soul produces
