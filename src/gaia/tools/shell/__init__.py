...
per-agent :class:`~gaia.tools.shell.base.ProcessManager` (terminated on process exit,
so nothing orphans), and the trio polls/stops/lists them. One file per tool;
:mod:`gaia.tools.shell.base` holds the manager, command-safety policy, and the
...
from gaia.tools.shell.list_procs import NAME as LIST
from gaia.tools.shell.list_procs import make_exec_list
from gaia.tools.shell.poll import NAME as POLL
from gaia.tools.shell.poll import make_exec_poll
from gaia.tools.shell.run import NAME as EXEC
from gaia.tools.shell.run import make_exec
