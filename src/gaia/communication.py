...
Distinct from folder skills (:mod:`gaia.skills`, capabilities loaded from disk):
...
A style is selected per agent in ``gaia.yaml`` (with a global default), and applied by
